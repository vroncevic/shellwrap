...
Copyright
    ...
    shellwrap is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'shellwrapdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'shellwrap.tex', 'shellwrap Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'shellwrap', 'shellwrap Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'shellwrap', 'shellwrap Documentation', author, 'shellwrap',
