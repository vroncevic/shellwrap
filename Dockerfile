...
RUN mkdir -p /root/scripts/shellwrap/ver.3.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/shellwrap/ver.3.0/
RUN cp -R /sh_tool/conf/  /root/scripts/shellwrap/ver.3.0/
RUN cp -R /sh_tool/log/   /root/scripts/shellwrap/ver.3.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/shellwrap/ver.3.0/
RUN ln -s /root/scripts/shellwrap/ver.3.0/bin/shellwrap.sh /root/bin/shellwrap
RUN tree /root/scripts/shellwrap/ver.3.0/
